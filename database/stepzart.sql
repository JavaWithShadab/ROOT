...
-- Dumping data for table stepzart.category: ~6 rows (approximately)
...
INSERT INTO `products` (`id`, `category`, `title`, `description`, `image`, `price`, `offer`, `location`, `user_id`) VALUES
	(1, 'MOBILES', 'test Title', 'sss', 'onlineServer.png', 999, 'Test Offer', 'Lucknow', 1),
	(3, 'ELECTRONICS', 'test Title', 'qqqqq', 'onlineServer.png', 1112, 'Test Offer', 'Kanpur', 1);
