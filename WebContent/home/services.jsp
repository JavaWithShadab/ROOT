					...
					<div class="side-bar col-md-3">
						...
						<div class="w3ls-featured-ads">
							...
							<div class="w3l-featured-ad">
								<a href="single.html">
									<div class="w3-featured-ad-left">
										<img src="${pageContext.request.contextPath}/images/f1.jpg" title="ad image" alt="" />
									</div>
							...
							<div class="w3l-featured-ad">
								<a href="single.html">
									<div class="w3-featured-ad-left">
										<img src="${pageContext.request.contextPath}/images/f2.jpg" title="ad image" alt="" />
									</div>
									<div class="w3-featured-ad-right">
										<h4>Lorem Ipsum is simply dummy text of the printing
											industry</h4>
							...
							<div class="w3l-featured-ad">
								<a href="single.html">
									<div class="w3-featured-ad-left">
										<img src="${pageContext.request.contextPath}/images/f3.jpg" title="ad image" alt="" />
									</div>
									<div class="w3-featured-ad-right">
										<h4>Lorem Ipsum is simply dummy text of the printing
											industry</h4>
											...
											<div id="container">
												...
												<ul class="list">
													...
													<a href="single.html">
														<li>
															<section class="list-left">
																<h5 class="title">It is a long established fact
																	that a reader</h5>
																<p class="catpath">Services » Other Services</p>
															</section>
															<section class="list-right">
													...
													<a href="single.html">
														<li>
															<section class="list-left">
																<h5 class="title">ducimus qui blanditiis
