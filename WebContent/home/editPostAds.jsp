				...
				<form action="${pageContext.request.contextPath}/product" method="post"
					...
					<div class="upload-ad-photos">
						...
						<div class="photos-upload-view">
							...
							<div>
								<img alt=""
									src="${pageContext.request.contextPath}/uploads/${requestScope.product.image1 }"
									class="img-rounded" height="200" width="200"> <input
									type="file" id="fileselect" name="file1" /><br> <img
									alt="" src="${pageContext.request.contextPath}/uploads/${requestScope.product.image2 }"
									class="img-rounded" height="200" width="200"><input
									type="file" id="fileselect" name="file2" /><br> <img
									alt="" src="${pageContext.request.contextPath}/uploads/${requestScope.product.image3 }"
									class="img-rounded" height="200" width="200"> <input
									type="file" id="fileselect" name="file3" /><br> <img
									alt="" src="${pageContext.request.contextPath}/uploads/${requestScope.product.image4 }"
									class="img-rounded" height="200" width="200"> <input
									type="file" id="fileselect" name="file4" /><br> <img
									alt="" src="${pageContext.request.contextPath}/uploads/${requestScope.product.image5 }"
									class="img-rounded" height="200" width="200"> <input
