			...
			<table class="table table-bordered table-striped">
				...
				<c:forEach var="product" items="${userProducts}">
					<tr>
						...
						<td><c:if test="${not empty product.image1  }">
								<img
									src="${pageContext.request.contextPath}/uploads/${product.image1 }"
									height="100" width="100" alt="${product.image1 }" />
							</c:if></td>
						<td><c:if test="${not empty product.image2  }">
								<img
									src="${pageContext.request.contextPath}/uploads/${product.image2 }"
									height="100" width="100" alt="${product.image2 }" />
							</c:if></td>
						<td><c:if test="${not empty product.image3  }">
								<img
									src="${pageContext.request.contextPath}/uploads/${product.image3 }"
									height="100" width="100" alt="${product.image3 }" />
							</c:if></td>
						<td><c:if test="${not empty product.image4  }">
								<img
									src="${pageContext.request.contextPath}/uploads/${product.image4 }"
									height="100" width="100" alt="${product.image4 }" />
							</c:if></td>
						<td><c:if test="${not empty product.image5  }">
								<img
									src="${pageContext.request.contextPath}/uploads/${product.image5 }"
									height="100" width="100" alt="${product.image5 }" />
							</c:if></td>
						...
						<td><a class="btn btn-warning"
							href="${pageContext.request.contextPath}/product?method=Edit_Ad&id=${product.id }">Edit</a></td>
			...
			<div class="w3l-popular-ads-info">
				<div class="col-md-4 w3ls-portfolio-left">
					<div class="portfolio-img event-img">
						<img src="${pageContext.request.contextPath}/images/s/ad1.jpg"
		...
		<div class="agile-info-mobile-app">
			<div class="container">
				...
				<div class="col-md-7 w3-app-right">
					<h3>
						stepzart App is the <span>Easiest</span> way for Selling and
