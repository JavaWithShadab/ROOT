	...
	<header>
		<div class="w3ls-header">
			...
			<div class="w3ls-header-left">
				<p>
					<a href="mobileapp.html"><i class="fa fa-download"
						aria-hidden="true"></i>Download Mobile App </a>
				</p>
			</div>
			<div class="w3ls-header-right">
				<ul>
					<li class="dropdown head-dpdn"><a href="signin.html"
		...
		<div class="container">
			<div class="agile-its-header">
				<div class="logo">
					<h1>
						<a href="index.html"><span>Re</span>sale-v2</a>
					</h1>
				</div>
			...
			<div class="product-desc">
				<div class="col-md-7 product-view">
					...
					<p>
						...
						<a href="#">city</a>| Added at 06:55 pm, Ad ID: 987654321
					</p>
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="/images/b10.jpg"><img src="/images/b10.jpg" />
							</li>
							<li data-thumb="/images/b11.jpg"><img src="/images/b11.jpg" />
							</li>
							<li data-thumb="/images/b12.jpg"><img src="/images/b12.jpg" />
							</li>
							<li data-thumb="/images/b13.jpg"><img src="/images/b13.jpg" />
							</li>
						</ul>
					</div>
					<!-- FlexSlider -->
					...
					<div class="product-details">
						<h4>
							<span class="w3layouts-agileinfo">Brand </span> : <a href="#">Company
								name</a>
							<div class="clearfix"></div>
						</h4>
						<h4>
							<span class="w3layouts-agileinfo">Views </span> : <strong>150</strong>
						</h4>
						<h4>
							<span class="w3layouts-agileinfo">Fuel </span> : Petrol
						</h4>
						<h4>
