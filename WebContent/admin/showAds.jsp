			...
			<table class="table table-bordered">
				...
				<c:forEach var="product" items="${posts }" varStatus="i">
					<tr>
						...
						<td>${product.price }</td>
						<td><img src="${pageContext.request.contextPath}/uploads/${product.image1}"
							class="img-thumbnail" height="100" width="100" /></td>
						<td>${product.user.email }</td>
						<td>${product.description }</td>
						<td><a href="${pageContext.request.contextPath}/admin/editAds.jsp?id=${product.id}"
							class="btn btn-info">Edit</a></td>
						<td><a href="${pageContext.request.contextPath}/admin/showAdss.jsp?id=${product.id }"
